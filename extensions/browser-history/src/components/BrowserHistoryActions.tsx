...
import { type HistoryEntry, type Preferences, SupportedBrowsers } from "../interfaces";

export { HistoryItemAction as HistoryItem, ActionOpenPreferences as OpenPreferences };
