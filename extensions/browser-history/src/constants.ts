...
export const defaultProfilePathFirefox =
  process.platform === "linux"
    ? [".mozilla", "firefox"]
    : ["Application Support", "Firefox", "Profiles"];
export const defaultProfilePathSafari = ["Safari", "History.db"];
export const defaultProfilePathEdge = [
  "Application Support",
  "Microsoft Edge",
  "Default",
  "History",
];
export const defaultProfilePathBrave = [
  "Application Support",
  "BraveSoftware",
  "Brave-Browser",
  "Default",
...
export const defaultProfilePathArc = [
  "Application Support",
  "Arc",
  "User Data",
  "Default",
...
export const defaultProfilePathOpera = [
  "Application Support",
