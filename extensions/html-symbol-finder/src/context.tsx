...
import { useRecentlyUsedItems } from "~/lib/used-recently-used-items";
import type { Character, CharacterSection } from "~/types";
import { buildList } from "~/helpers/list";
...
export const ListContext = createContext<ListContext>(null as unknown as ListContext);
...
export const ListContextProvider: FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const setDatasetFilterAnd = (filter: string | null) => {
