                  ...
                  .map(({ word, epoch }) => (
                    <List.Item
                      ...
                      accessories={[
                        {
                          icon: Icon.Clock,
                          text: new Date(epoch).toLocaleString(),
                        },
                      ]}
                      actions={
                        <ActionPanel>
                          ...
                          <ActionPanel.Section>
                            <Action
                              ...
                              shortcut={Keyboard.Shortcut.Common.Remove as Keyboard.Shortcut.Common}
                              onAction={async (): Promise<void> => {
                            ...
                            <Action
                              ...
                              icon={Icon.Trash}
                              style={Action.Style.Destructive}
                              shortcut={Keyboard.Shortcut.Common.RemoveAll as Keyboard.Shortcut.Common}
                              onAction={async (): Promise<void> => {
                                const options: Alert.Options = {
                                  title: "Clear History",
