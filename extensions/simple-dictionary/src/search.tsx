...
export default function Command(props: LaunchProps<{ arguments: { language?: string; word: string } }>): JSX.Element {
  let d: Dictionary;

  const colors: Color[] = [Color.Blue, Color.Green, Color.Magenta, Color.Orange, Color.Purple, Color.Red, Color.Yellow];

  type SearchPreferences = { default_language: string };
  const language: string = props.arguments.language || getPreferenceValues<SearchPreferences>().default_language;
                    ...
                    actions={
                      <ActionPanel>
                        ...
                        <Action
                          ...
                          shortcut={isFavorite ? Keyboard.Shortcut.Common.Remove as Keyboard.Shortcut.Common : Keyboard.Shortcut.Common.Pin as Keyboard.Shortcut.Common}
