...
type Props = {
	...
	sudoCommand?: string;
	/** Exact terminal retry for operations that span multiple commands. */
	terminalRetry?: { label: string; args: string[] } | null;
};
		...
		<ActionPanel title={title}>
			...
			{terminalRetry ? (
				<Action.RunInTerminal
					title={terminalRetry.label}
					icon={Icon.Terminal}
					args={terminalRetry.args}
					options={{ hold: true }}
				/>
