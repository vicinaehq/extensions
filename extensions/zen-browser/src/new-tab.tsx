...
export default function Command() {
  ...
  return <List searchText={query} onSearchTextChange={setQuery} searchBarPlaceholder="Search or enter URL…" actions={<ActionPanel><Action title="Open in Zen" icon={Icon.Globe01} onAction={open}/></ActionPanel>}>
    {query ? <List.Item title={`Open “${query}”`} subtitle={normalizeUrlOrSearch(query,prefs.searchEngine)} icon={Icon.Globe01} actions={<ActionPanel><Action title="Open in Zen" icon={Icon.Globe01} onAction={open}/></ActionPanel>} /> : null}
