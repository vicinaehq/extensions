...
describe("eventProcessing", () => {
  ...
  describe("calendarsChanged", () => {
    describe("given identical calendars", () => {
      const a = [
      ...
      describe("when comparing", () => {
        it("then returns false", () => {
          expect(calendarsChanged(a as any, b as any)).toBe(false);
        });
      });
    });

    describe("given calendars with same content in different order", () => {
      const a = [
        { url: "https://example.com/cal1", name: "Cal 1", color: "blue" },
        { url: "https://example.com/cal2", name: "Cal 2", color: "red" },
      ];
      ...
      describe("when comparing", () => {
        it("then returns false (order independent)", () => {
          expect(calendarsChanged(a as any, b as any)).toBe(false);
        });
      });
    });

    describe("given calendars with different URLs", () => {
      const a = [
        { url: "https://example.com/cal1", name: "Cal", color: "blue" },
      ];
      const b = [
        { url: "https://example.com/cal2", name: "Cal", color: "blue" },
      ];

      describe("when comparing", () => {
        it("then returns true", () => {
          expect(calendarsChanged(a as any, b as any)).toBe(true);
        });
      });
    });

    describe("given calendars with different names", () => {
      const a = [
        { url: "https://example.com/cal", name: "Cal A", color: "blue" },
      ];
      const b = [
        { url: "https://example.com/cal", name: "Cal B", color: "blue" },
      ];
    ...
    describe("given different number of calendars", () => {
      const a = [
        { url: "https://example.com/cal1", name: "Cal 1", color: "blue" },
      ];
      const b = [
    ...
    describe("given empty arrays", () => {
      describe("when comparing", () => {
        it("then returns false", () => {
          expect(calendarsChanged([], [])).toBe(false);
        });
      });
    });
  });
